...
# BatchMode: Fragt der Schlüssel nach einer Passphrase, soll es abbrechen
# statt stumm auf eine Eingabe zu warten, die niemand sieht.
...
# Ein „Everything up-to-date" sieht wie Erfolg aus, auch wenn man auf dem
# falschen Zweig steht.
...
# erst mitrutschen — die Ausschlussliste unten ist nur noch der zweite Riegel.
...
AUSPACK=$(mktemp -d "/tmp/zerberus-pack-XXXXXX") || abbruch_mktemp
